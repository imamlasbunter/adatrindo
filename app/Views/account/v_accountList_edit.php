                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit Account List</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-sm-8 mt-3">
                                <form action="<?= base_url('journal-setting/list/edit/' . $edit['id']) ?>" method="post" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="account_number" class="form-control <?= ($validation->hasError('account_number')) ? 'is-invalid' : ''; ?>" id="account_number" placeholder="account_number" value="<?= ($validation->hasError('account_number')) ? old('account_number') : $edit['account_number']; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="account_name" class="form-control <?= ($validation->hasError('account_name')) ? 'is-invalid' : ''; ?>" id="account_name" placeholder="account_name" value="<?= ($validation->hasError('account_number')) ? old('account_number') : $edit['account_number']; ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="account_category" class="form-control <?= ($validation->hasError('account_category')) ? 'is-invalid' : ''; ?>" id="account_category" placeholder="Account Category">
                                                ...
                                                <?php foreach ($accountcategory as $row) : ?>
                                                    <option value="<?= $row['id']; ?>" <?= ($row['id'] == old('account_category')) ? 'selected' : ''; ?> <?= ($edit['account_category_id'] == $row['id']) ? 'selected' : '' ?>><?= $row['name']; ?></option>
                                                <?php endforeach; ?>
                                                <select>
                                                    <div class="invalid-feedback">
