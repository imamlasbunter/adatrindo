                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-sm-8 mt-3">
                                <form action="<?= base_url('users/edit/' . $edit['id']) ?>" method="post" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="username" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : ''; ?>" id="username" placeholder="Username" value="<?= (old('username')) ? old('username') : $edit['username']; ?>" readonly>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="name" name="name" class="form-control <?= ($validation->hasError('name')) ? 'is-invalid' : ''; ?>" id="name" placeholder="Name" value="<?= (old('name')) ? old('name') : $edit['name']; ?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="level" class="form-control <?= ($validation->hasError('level')) ? 'is-invalid' : ''; ?>" id="level" placeholder="Level User">
                                                ...
                                                <?php foreach ($level as $row) : ?>
                                                    <option value="<?= $row['id']; ?>" <?= ($row['id'] == old('level') || $row['id'] == $edit['level']) ? 'selected' : ''; ?>><?= $row['descripsion']; ?></option>
                                                <?php endforeach; ?>
                                                <select>
                                                    <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="email" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" id="email" placeholder="Email" value="<?= (old('email')) ? old('email') : $edit['email']; ?>">
                                            <div class="invalid-feedback">
