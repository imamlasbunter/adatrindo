                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-sm-8 mt-3">
                                <form action="<?= base_url('category/edit/' . $edit['id']) ?>" method="post" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="category" class="form-control <?= ($validation->hasError('category')) ? 'is-invalid' : ''; ?>" id="category" placeholder="Category" value="<?= ($validation->hasError('category')) ? old('category') : $edit['category']; ?>">
