                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form New Contact</h3>
                        </div>
                        <div class="card-body">
                            <form action="<?= base_url('contact/add') ?>" method="POST" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <div class="row">
                                    <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="contact_type" class="form-control <?= ($validation->hasError('contact_type')) ? 'is-invalid' : ''; ?>" id="contact_type" placeholder="Contact Type">
                                                    ...
                                                    <option value="1" <?= (old('contact_type')) ? "selected" : "" ?>>Customer</option>
                                                    <option value="2" <?= (old('contact_type')) ? "selected" : "" ?>>Supplier</option>
                                                    <option value="3" <?= (old('contact_type')) ? "selected" : "" ?>>Employee</option>
                                                    <option value="4" <?= (old('contact_type')) ? "selected" : "" ?>>Vendor</option>
                                                    <option value="5" <?= (old('contact_type')) ? "selected" : "" ?>>Others</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="hp" class="form-control <?= ($validation->hasError('hp')) ? 'is-invalid' : ''; ?>" id="hp" placeholder="Handphone" value="<?= old('hp'); ?>">
                                                <div class=" invalid-feedback">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <select name="identity_type" class="form-control <?= ($validation->hasError('identity_type')) ? 'is-invalid' : ''; ?>" id="identity_type" placeholder="Identity Type">
                                                            ...
                                                            <option value="1" <?= (old('identity_type')) ? "selected" : "" ?>>KTP</option>
                                                            <option value="2" <?= (old('identity_type')) ? "selected" : "" ?>>SIM</option>
                                                            <option value="3" <?= (old('identity_type')) ? "selected" : "" ?>>Passport</option>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name="no_identity" class="form-control <?= ($validation->hasError('no_identity')) ? 'is-invalid' : ''; ?>" id="no_identity" placeholder="Nomor Identity" value="<?= old('no_identity'); ?>">
                                                        <div class="invalid-feedback">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="payment_address" class="form-control <?= ($validation->hasError('payment_address')) ? 'is-invalid' : ''; ?>" id="payment_address" placeholder="Payment Address"><?= old('payment_address'); ?></textarea>
                                                <div class=" invalid-feedback">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="bautno" class="form-control <?= ($validation->hasError('bautno')) ? 'is-invalid' : ''; ?>" id="bautno" placeholder="Bank account under the Name (Of)" value="<?= old('bautno'); ?>">
                                                <div class="invalid-feedback">
