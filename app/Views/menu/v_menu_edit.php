                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-sm-8 mt-3">
                                <form action="<?= base_url('menu/edit/' . $edit['id']) ?>" method="post" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                        ...
                                        <div class="col-sm-9">
                                            <select name="category_menu" class="form-control <?= ($validation->hasError('category_menu')) ? 'is-invalid' : ''; ?>" id="category_menu" placeholder="Unit Product">
                                                ...
                                                <?php foreach ($category_menu->getresultarray() as $row) : ?>
                                                    <option value="<?= $row['id']; ?>" <?= ($row['id'] == old('category_menu') || $row['id'] == $edit['category_menu']) ? 'selected' : $edit['category_menu']; ?>><?= $row['name']; ?></option>
                                                <?php endforeach; ?>
                                                <select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="menu_name" class="form-control <?= ($validation->hasError('menu_name')) ? 'is-invalid' : ''; ?>" id="menu_name " placeholder="Menu name" value="<?= (old('menu_name')) ? old('menu_name') : $edit['menu_name']; ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="sequence" class="form-control <?= ($validation->hasError('sequence')) ? 'is-invalid' : ''; ?>" id="sequence" placeholder="Sequence" value="<?= (old('sequence')) ? old('sequence') : $edit['sequence']; ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="status" class="form-control <?= ($validation->hasError('status')) ? 'is-invalid' : ''; ?>" id="status" value="<?= old('status'); ?>">
                                                ...
                                                <option value="A" <?= (old('status') == 'A' || $edit['status'] == 'A') ? 'selected' : '' ?>>Aktif</option>
                                                <option value="N" <?= (old('status') == 'A' || $edit['status'] == 'N') ? 'selected' : '' ?>>Non Aktif</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="test" name="icon_menu" class="form-control <?= ($validation->hasError('icon_menu')) ? 'is-invalid' : ''; ?>" id="icon_menu " placeholder="Icon Menu" value="<?= (old('icon_menu')) ? old('icon_menu') : $edit['icon_menu']; ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="link_menu" class="form-control <?= ($validation->hasError('link_menu')) ? 'is-invalid' : ''; ?>" id="link_menu" placeholder="Menu Link" value="<?= (old('link_menu')) ? old('link_menu') : $edit['link_menu']; ?>">
                                            <div class="invalid-feedback">
