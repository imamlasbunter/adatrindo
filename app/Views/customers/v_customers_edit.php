                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-sm-8 mt-3">
                                <form action="<?= base_url('/customers/edit/' . $edit['id']) ?>" method="post" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-2 col-form-label">Customers Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control <?= ($validation->hasError('name')) ? 'is-invalid' : ''; ?>" id="name" placeholder="Customers Name" value="<?= ($validation->hasError('name')) ? old('name') : $edit['name']; ?>">
