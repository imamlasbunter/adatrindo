                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-sm-8 mt-3">
                                <form action="<?= base_url('/suppliers/add') ?>" method="POST" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="supplier_name" class="form-control <?= ($validation->hasError('supplier_name')) ? 'is-invalid' : ''; ?>" id="supplier_name" placeholder="Suppliers Name" value="<?= old('supplier_name'); ?>">
