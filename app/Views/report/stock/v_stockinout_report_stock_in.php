      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form action="<?php echo site_url('stock-in-out-report/stock-in'); ?>" method="GET">
                <?= csrf_field(); ?>
                <div class="row">
                  <div class="col-md-3">
...
<script>
  $(document).ready(function() {
    $.ajax({
      ...
      url: "<?php echo site_url(); ?>stock-in-out-report/stock-in/graph",
      cache: false,
