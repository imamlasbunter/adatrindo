                                ...
                                <tbody>
                                    ...
                                    foreach ($stockout as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?= $row['category']; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#stockin<?= $row['id']; ?>">
                                                    <i class="fas fa-edit nav-icon"></i>
                                                </button>
                                                <a class="btn btn-info btn-xs" href="<?= base_url('stock-in/detail/' . $row['product_code']) ?>"><i class="fas fa-eye nav-icon"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
...
<?php foreach ($stockout as $row) : ?>
    <form action="<?= base_url('/stock-in/save') ?>" method="POST" enctype="multipart/form-data">
        <div class="modal fade" id="stockin<?= $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <span class="modal-title">Form Stock In</span>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="quantity" min="1" class="form-control <?= ($validation->hasError('quantity')) ? 'is-invalid' : ''; ?>" id="quantity" placeholder="Quantity" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea type="description" name="description" class="form-control <?= ($validation->hasError('description')) ? 'is-invalid' : ''; ?>" id="description" placeholder="Reason stock in" required></textarea>
                                <div class="invalid-feedback">
