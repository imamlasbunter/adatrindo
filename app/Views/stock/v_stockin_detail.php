                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">
                            <a href="<?= base_url('stock-in') ?>" class="btn btn-primary btn-sm">Back</a>
                        </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title">Data Products Stock In</h3>
                                </div>
                                <div class="col-md-6">
...
<?php foreach ($stockout as $row) : ?>
    <form action="<?= base_url('/stock-in/restore') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <span class="modal-title">Form Stock In Restore</span>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="qty_si" value="<?= $row['qty']; ?>" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="quantity_restore_si" min="1" max="<?= $row['qty'] ?>" class="form-control <?= ($validation->hasError('quantity')) ? 'is-invalid' : ''; ?>" id="quantity" placeholder="Quantity" required>
